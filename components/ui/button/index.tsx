...
const buttonStyle = tva({
  ...
  variants: {
    action: {
      ...
      blue: 'bg-primary-500 data-[hover=true]:bg-blue-600 data-[active=true]:bg-blue-700 border-blue-300 data-[hover=true]:border-blue-400 data-[active=true]:border-blue-500 data-[focus-visible=true]:web:ring-indicator-info',
      secondary:
...
const buttonTextStyle = tva({
  ...
  parentVariants: {
    action: {
      ...
      blue: 'text-blue-600 data-[hover=true]:text-blue-600 data-[active=true]:text-blue-700',
      secondary:
